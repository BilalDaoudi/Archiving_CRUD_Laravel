<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="nav-item">
            <div>
                <h4><b><i><?php echo $__env->yieldContent('title'); ?></i></b></h4>
            </div>
        </li>
    </ul>
...
</nav><?php /**PATH C:\xampp\htdocs\Laravel\Laravel_Projects\GestionLocation\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>