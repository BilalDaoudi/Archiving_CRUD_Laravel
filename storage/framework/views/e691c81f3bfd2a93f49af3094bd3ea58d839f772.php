...
<body>
    ...
    <div class="wrapper">
        ...
        <?php $__env->startSection('title','Archive Clients'); ?>
                    ...
                    <tbody class="" id="resultats">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group" role="group">
                                <form method="post" action="<?php echo e(route('client.restore',$row->CIN)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn" style="font-size: 18px;height:30px;background:none;"><i class="ti-back-left"></i></button>
                                    </form>
                                    <form method="post" action="<?php echo e(route('client.forcedelete',$row->CIN)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field("DELETE"); ?>
                                        <button type="submit" class="btn" style="font-size: 18px;height:30px;background:none;"><i class="ti-trash"></i></button>
                                    </form>
...
<?php echo $__env->make('layouts.main-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Projects\GestionLocation\resources\views/Clients/ArchiveClients.blade.php ENDPATH**/ ?>