<div class="container-fluid">
    <div class="row">
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="<?php echo e(route('client.archive')); ?>"><i class="ti-user"></i><span class="right-nav-text">Archivage Clients</span> </a>
                    </li>
                    <!-- <li>
        ...
        </div><?php /**PATH C:\xampp\htdocs\Projets_Laravel\GestionLocation\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>